          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form @submit.prevent="saveType">
                ...
                <div class="mb-3">
                  <label class="form-label">ชื่่อประเภทสินค้า</label>
  ...
  export default {
    ...
    setup() {
      ...
      const fetchTypes = async () => {
        try {
          const response = await fetch("http://localhost/app-vue01/php.api/type_crud.php");
      ...
      const saveType = async () => {
        const url = "http://localhost/app-vue01/php.api/type_crud.php";
