        ...
        <tbody>
          <tr v-for="employee in employees" :key="employee.emp_id">
            ...
            <td>
              ...
              |
              <button class="btn btn-danger btn-sm" @click="deletEmployees(employee.emp_id)">
                ลบ
              </button>
            </td>
          </tr>
  ...
  export default {
    ...
    setup() {
      ...
      const fetchEmployees = async () => {
        try {
          const response = await fetch("http://localhost/app-vue01/php.api/employees_crud.php");
      ...
      const saveEmployees = async () => {
        const url = "http://localhost/app-vue01/php.api/employees_crud.php";
